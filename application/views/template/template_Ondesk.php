...
<body class="hold-transition skin-blue-light sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?= base_url('Ondesk') ?>" class="logo">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="<?= site_url('Ondesk/viewListODP') ?>">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= site_url('Ondesk/getRegional') ?>"><i class="fa fa-flag fa-fw mr-3"></i> Regional</a></li>
              <li><a href="<?= site_url('Ondesk/getWitel') ?>"><i class="fa fa-map-marker fa-fw mr-3"></i> Witel</a></li>
              <li><a href="<?= site_url('Ondesk/getDatel') ?>"><i class="fa fa-tag fa-fw mr-3"></i> Datel</a></li>
              <li><a href="<?= site_url('Ondesk/getSTO') ?>"><i class="fa fa-location-arrow fa-fw mr-3"></i> STO</a></li>
              <li><a href="<?= site_url('Ondesk/getSpecOLT') ?>"><i class="fa fa-wrench fa-fw mr-3"></i> Specification OLT</a></li>
            </ul>
          </li>
          <?php if ($this->fungsi->user_login()->status == 'Admin') { ?>
            <li class="header">SETTNGS</li>
            <li><a href="<?= site_url('Ondesk/getPegawai') ?>">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      tabel = $('#tableValidasi').DataTable({
        ...
        "ajax": {
          "url": "<?= base_url() ?>index.php/Ondesk/loadDataValidasi", // URL file untuk proses select datanya
          "type": "POST"
        },
        "deferRender": true,
        "aLengthMenu": [
          ...
          },
          {
            "render": function(data, type, row) { // Tampilkan kolom aksi
              var html = "<div class='text-center'>" +
                "<a href='<?= site_url() ?>Ondesk/editValidasi/" + row.id + "' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a> " +
                " <a href='<?= site_url() ?>Ondesk/deleteValidasi/" + row.id + "' onclick='return confirm(\"Anda yakin?\");' class='btn btn-danger btn-xs'><i class='fa fa-trash'></i></a> " +
                "</div>";
      ...
      $('#search').click(function() {
        ...
        if (start_date != '' && end_date != '') {
          ...
          $('#tableFilter').DataTable({
            ...
            "ajax": {
              "url": "<?= base_url() ?>index.php/Ondesk/filterDate", // URL file untuk proses select datanya
              "type": "POST",
              data: {
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      tabel = $('#tableODP').DataTable({
        ...
        "bScrollCollapse": true,
        "ajax": {
          "url": "<?= base_url() ?>index.php/Ondesk/loadDataODP", // URL file untuk proses select datanya
          "type": "POST"
        },
        "deferRender": true,
        "aLengthMenu": [
        ...
        "columns": [{
          ...
          },
          {
            "render": function(data, type, row) { // Tampilkan kolom aksi
              var html = "<div class='text-center'>" +
                "<a href='<?= site_url() ?>Ondesk/editODP/" + row.idODP + "' class='btn btn-primary btn-xs disabled'><i class='fa fa-pencil'></i></a> " +
                " <a href='<?= site_url() ?>Ondesk/deleteODP/" + row.idODP + "' onclick='return confirm(\"Anda yakin?\");' class='btn btn-danger btn-xs disabled'><i class='fa fa-trash'></i></a> " +
                "</div>";
...
$(document).ready(function () {
    ...
    $('body').on('focus',"#updaterUIM", function(){
        ...
        $(this).select2({
            ...
            ajax: { 
                url: "<?= base_url() ?>index.php/Ondesk/listHDDaman",
                type: "post",
                dataType: 'json',
                delay: 250,
    ...
    $('body').on('focus',"#updaterDava", function(){
        $(this).select2({
            placeholder: "Select an option",
            ajax: { 
                url: "<?= base_url() ?>index.php/Ondesk/listDava",
                type: "post",
                dataType: 'json',
                delay: 250,
                data: function (params) {
    ...
    $("#namaODP").select2({
        placeholder: "Select an option",
        ajax: { 
            url: "<?= base_url() ?>index.php/Ondesk/listNamaODP",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function (params) {
    ...
    $("#namaOLT").select2({
        placeholder: "Select an option",
        ajax: { 
            url: "<?= base_url() ?>index.php/Ondesk/listNamaOLT",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function (params) {
