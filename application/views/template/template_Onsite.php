            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?= site_url('Onsite/editProfile') ?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= site_url('Onsite/getRegional') ?>"><i class="fa fa-flag fa-fw mr-3"></i> Regional</a></li>
              <li><a href="<?= site_url('Onsite/getWitel') ?>"><i class="fa fa-map-marker fa-fw mr-3"></i> Witel</a></li>
              <li><a href="<?= site_url('Onsite/getDatel') ?>"><i class="fa fa-tag fa-fw mr-3"></i> Datel</a></li>
              <li><a href="<?= site_url('Onsite/getSTO') ?>"><i class="fa fa-location-arrow fa-fw mr-3"></i> STO</a></li>
              <li><a href="<?= site_url('Onsite/getSpecOLT') ?>"><i class="fa fa-wrench fa-fw mr-3"></i> Specification OLT</a></li>
            </ul>
          </li>
          <?php if ($this->fungsi->user_login()->status == 'Admin') { ?>
            <li class="header">SETTNGS</li>
            <li><a href="<?= site_url('Onsite/getPegawai') ?>">
          ...
          },
          {
            "render": function(data, type, row) { // Tampilkan kolom aksi
              var html = "<div class='text-center'>" +
                "<a href='<?= site_url() ?>Onsite/editValidasi/" + row.id + "' class='btn btn-primary btn-xs disabled'><i class='fa fa-pencil '></i></a> " +
                " <a href='<?= site_url() ?>Onsite/deleteValidasi/" + row.id + "' onclick='return confirm(\"Anda yakin?\");' class='btn btn-danger btn-xs disabled'><i class='fa fa-trash'></i></a> " +
                "</div>";
      ...
      tabel = $('#tableODP').DataTable({
        ...
        "columns": [{
          ...
          },
          {
            "render": function(data, type, row) { // Tampilkan kolom aksi
              var html = "<div class='text-center'>" +
                "<a href='<?= site_url() ?>Onsite/editODP/" + row.idODP + "' class='btn btn-primary btn-xs disabled'><i class='fa fa-pencil'></i></a> " +
                " <a href='<?= site_url() ?>Onsite/deleteODP/" + row.idODP + "' onclick='return confirm(\"Anda yakin?\");' class='btn btn-danger btn-xs disabled'><i class='fa fa-trash'></i></a> " +
                "</div>";
...
$(document).ready(function () {
    ...
    $('body').on('focus',"#updaterUIM", function(){
        ...
        $(this).select2({
            ...
            ajax: { 
                url: "<?= base_url() ?>index.php/Onsite/listHDDaman",
                type: "post",
                dataType: 'json',
                delay: 250,
    ...
    $('body').on('focus',"#updaterDava", function(){
        $(this).select2({
            placeholder: "Select an option",
            ajax: { 
                url: "<?= base_url() ?>index.php/Onsite/listDava",
                type: "post",
                dataType: 'json',
                delay: 250,
                data: function (params) {
    ...
    $("#namaODP").select2({
        placeholder: "Select an option",
        ajax: { 
            url: "<?= base_url() ?>index.php/Onsite/listNamaODP",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function (params) {
    ...
    $("#namaOLT").select2({
        placeholder: "Select an option",
        ajax: { 
            url: "<?= base_url() ?>index.php/Onsite/listNamaOLT",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function (params) {
