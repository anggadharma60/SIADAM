...
<body class="hold-transition skin-blue-light sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?= base_url('Dava') ?>" class="logo">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?= site_url('Dava/editProfile') ?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= site_url('Dava/filtering') ?>"><i class="fa fa-filter fa-fw mr-3"></i> Filtering</a></li>
              <li><a href="<?= site_url('Dava/chart') ?>"><i class="fa fa-pie-chart fa-fw mr-3"></i> Chart</a></li>
            </ul>
          </li>
          <li>
            <a href="<?= site_url('Dava/viewListValidasi') ?>">
              <i class="fa fa-cog"></i> <span>Kelola Data Validasi</span>
              <span class="pull-right-container"></span>
            </a>
          </li>
          <li>
            <a href="<?= site_url('Dava/viewListODP') ?>">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= site_url('Dava/getRegional') ?>"><i class="fa fa-flag fa-fw mr-3"></i> Regional</a></li>
              <li><a href="<?= site_url('Dava/getWitel') ?>"><i class="fa fa-map-marker fa-fw mr-3"></i> Witel</a></li>
              <li><a href="<?= site_url('Dava/getDatel') ?>"><i class="fa fa-tag fa-fw mr-3"></i> Datel</a></li>
              <li><a href="<?= site_url('Dava/getSTO') ?>"><i class="fa fa-location-arrow fa-fw mr-3"></i> STO</a></li>
              <li><a href="<?= site_url('Dava/getSpecOLT') ?>"><i class="fa fa-wrench fa-fw mr-3"></i> Specification OLT</a></li>
            </ul>
          </li>
          <?php if ($this->fungsi->user_login()->status == 'Admin') { ?>
            <li class="header">SETTNGS</li>
            <li><a href="<?= site_url('Dava/getPegawai') ?>">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      tabel = $('#tableValidasi').DataTable({
        ...
        "ajax": {
          "url": "<?= base_url() ?>index.php/Dava/loadDataValidasi", // URL file untuk proses select datanya
          "type": "POST"
        },
        "deferRender": true,
        "aLengthMenu": [
          ...
          },
          {
            "render": function(data, type, row) { // Tampilkan kolom aksi
              var html = "<div class='text-center'>" +
                "<a href='<?= site_url() ?>Dava/editValidasi/" + row.id + "' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a> " +
                " <a href='<?= site_url() ?>Dava/deleteValidasi/" + row.id + "' onclick='return confirm(\"Anda yakin?\");' class='btn btn-danger btn-xs'><i class='fa fa-trash'></i></a> " +
                "</div>";
      ...
      $('#search').click(function() {
        ...
        if (start_date != '' && end_date != '') {
          ...
          $('#tableFilter').DataTable({
            ...
            "ajax": {
              "url": "<?= base_url() ?>index.php/Dava/filterDate", // URL file untuk proses select datanya
              "type": "POST",
              data: {
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      tabel = $('#tableODP').DataTable({
        ...
        "bScrollCollapse": true,
        "ajax": {
          "url": "<?= base_url() ?>index.php/Dava/loadDataODP", // URL file untuk proses select datanya
          "type": "POST"
        },
        "deferRender": true,
        "aLengthMenu": [
        ...
        "columns": [{
          ...
          },
          {
            "render": function(data, type, row) { // Tampilkan kolom aksi
              var html = "<div class='text-center'>" +
                "<a href='<?= site_url() ?>Dava/editODP/" + row.idODP + "' class='btn btn-primary btn-xs disabled'><i class='fa fa-pencil'></i></a> " +
                " <a href='<?= site_url() ?>Dava/deleteODP/" + row.idODP + "' onclick='return confirm(\"Anda yakin?\");' class='btn btn-danger btn-xs disabled'><i class='fa fa-trash'></i></a> " +
                "</div>";
...
$(document).ready(function () {
    ...
    $('body').on('focus',"#updaterUIM", function(){
        ...
        $(this).select2({
            ...
            ajax: { 
                url: "<?= base_url() ?>index.php/Dava/listHDDaman",
                type: "post",
                dataType: 'json',
                delay: 250,
    ...
    $('body').on('focus',"#updaterDava", function(){
        $(this).select2({
            placeholder: "Select an option",
            ajax: { 
                url: "<?= base_url() ?>index.php/Dava/listDava",
                type: "post",
                dataType: 'json',
                delay: 250,
                data: function (params) {
    ...
    $("#namaODP").select2({
        placeholder: "Select an option",
        ajax: { 
            url: "<?= base_url() ?>index.php/Dava/listNamaODP",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function (params) {
    ...
    $("#namaOLT").select2({
        placeholder: "Select an option",
        ajax: { 
            url: "<?= base_url() ?>index.php/Dava/listNamaOLT",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function (params) {
