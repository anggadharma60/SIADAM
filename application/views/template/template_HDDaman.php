...
<body class="hold-transition skin-blue-light sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?= base_url('HDDaman') ?>" class="logo">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?= site_url('HDDaman/editProfile') ?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="active treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= site_url('HDDaman/filtering') ?>"><i class="fa fa-filter fa-fw mr-3"></i> Filtering</a></li>
              <li><a href="<?= site_url('HDDaman/chart') ?>"><i class="fa fa-pie-chart fa-fw mr-3"></i> Chart</a></li>
            </ul>
          </li>
          <li>
            <a href="<?= site_url('HDDaman/viewListValidasi') ?>">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      tabel = $('#tableValidasi').DataTable({
        ...
        "ajax": {
          "url": "<?= base_url() ?>index.php/HDDaman/loadDataValidasi", // URL file untuk proses select datanya
          "type": "POST"
        },
        "deferRender": true,
        "aLengthMenu": [
          ...
          },
          {
            "render": function(data, type, row) { // Tampilkan kolom aksi
              var html = "<div class='text-center'>" +
                "<a href='<?= site_url() ?>HDDaman/editValidasi/" + row.id + "' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a> " +
                " <a href='<?= site_url() ?>HDDaman/deleteValidasi/" + row.id + "' onclick='return confirm(\"Anda yakin?\");' class='btn btn-danger btn-xs'><i class='fa fa-trash'></i></a> " +
                "</div>";
      ...
      $('#search').click(function() {
        ...
        if (start_date != '' && end_date != '') {
          ...
          $('#tableFilter').DataTable({
            ...
            "ajax": {
              "url": "<?= base_url() ?>index.php/HDDaman/filterDate", // URL file untuk proses select datanya
              "type": "POST",
              data: {
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      tabel = $('#tableODP').DataTable({
        ...
        "bScrollCollapse": true,
        "ajax": {
          "url": "<?= base_url() ?>index.php/HDDaman/loadDataODP", // URL file untuk proses select datanya
          "type": "POST"
        },
        "deferRender": true,
        "aLengthMenu": [
