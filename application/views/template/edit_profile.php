        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php if ($this->fungsi->user_login()->status == 'Ondesk') { ?>
                    <a href="<?= site_url('Ondesk') ?>" class="btn btn-danger btn-flat">
                        <i class="fa fa-undo"></i> Back
                    </a>
                <?php } ?>
                <?php if ($this->fungsi->user_login()->status == 'Onsite') { ?>
                    <a href="<?= site_url('Onsite') ?>" class="btn btn-danger btn-flat">
                        <i class="fa fa-undo"></i> Back
                    </a>
                <?php } ?>
                <?php if ($this->fungsi->user_login()->status == 'Daman') { ?>
                    <a href="<?= site_url('HD Daman') ?>" class="btn btn-danger btn-flat">
                        <i class="fa fa-undo"></i> Back
                    </a>
                <?php } ?>
                ...
                <?php if ($this->fungsi->user_login()->status == 'Dava') { ?>
                    <a href="<?= site_url('Dava') ?>" class="btn btn-danger btn-flat">
                        <i class="fa fa-undo"></i> Back
                    </a>
                <?php } ?>
                <?php if ($this->fungsi->user_login()->status == 'SDI') { ?>
                    <a href="<?= site_url('SDI') ?>" class="btn btn-danger btn-flat">
                        <i class="fa fa-undo"></i> Back
                    </a>
                <?php } ?>
            </div>
