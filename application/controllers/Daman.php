...
class Daman extends CI_Controller
{
	...
	public function addPegawai()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Daman', 'pegawai/pegawai_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editPegawai($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Daman', 'pegawai/pegawai_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Daman/getPegawai');
			}
	...
	public function detailPegawai($id)
	{
		...
		$this->template->load('template/template_Daman', 'pegawai/pegawai_form_detail', $data);
	}
	...
	public function addRegional()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Daman', 'regional/regional_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editRegional($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Daman', 'regional/regional_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Daman/getRegional');
			}
	...
	public function addWitel()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Daman', 'witel/witel_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editWitel($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Daman', 'witel/witel_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Daman/getWitel');
			}
	...
	public function addDatel()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Daman', 'datel/datel_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editDatel($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Daman', 'datel/datel_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Daman/getDatel');
			}
	...
	public function addSTO()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Daman', 'sto/sto_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editSTO($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Daman', 'sto/sto_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Daman/getSTO');
			}
	...
	public function addSpecOLT()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Daman', 'specolt/specolt_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editSpecOLT($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Daman', 'specolt/specolt_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Daman/getSpecOLT');
			}
	...
	{
		$this->template->load('template/template_Daman', 'odp/odp_form_import');
	}
	...
	public function addODP()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Daman', 'odp/odp_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editODP($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Daman', 'odp/odp_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Daman/viewListODP');
			}
	...
	{
		$this->template->load('template/template_Daman', 'olt/olt_form_import');
	}
	...
	public function addOLT()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Daman', 'olt/olt_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editOLT($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Daman', 'olt/olt_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Daman/getOLT');
			}
	...
	{
		$this->template->load('template/template_Daman', 'validasi/validasi_form_import');
	}
	...
	public function importValidasi()
	{
		...
		if (!empty($_FILES['fileURL']['name'])) {
			...
			if ($flag == 1) {
				...
				redirect('Daman/viewListValidasi');
			} else {
	...
	public function addValidasi()
	{
		...
		$this->form_validation->set_rules('ondesk', 'Daman', 'required|trim');
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->template->load('template/template_Daman', 'validasi/Validasi_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editValidasi($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->template->load('template/template_Daman', 'validasi/Validasi_form_edit', $data);
		} else {
			$post = $this->input->post(null, TRUE);
