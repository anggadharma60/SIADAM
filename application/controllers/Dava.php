...
class Dava extends CI_Controller
{
	function __construct()
	{
		parent::__construct();
		check_not_login();
		//check Dava buat fungsi_helper
		check_Dava();
		// check_daman();
		// check_hddaman();
		// check_ondesk();
	...
	{
		check_not_login();
		$this->template->load('template/template_Dava', 'dashboard_home');
	}
	...
	public function editProfile()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Dava', 'template/edit_profile', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/getPegawai');
			}
		} else {
	...
	public function chart()
	{
		...
		$this->template->load('template/template_Dava', 'dashboard/chart', $data);
		
		// $this->template->load('template/template_Dava', 'dashboard/chart');
	}

	public function filtering()
	{
		$this->template->load('template/template_Dava', 'dashboard/filtering');
	}
	//End Dashboard
	...
	public function getPegawai()
	{
		...
		$this->template->load('template/template_Dava', 'pegawai/pegawai_data', $data);
	}
	...
	public function addPegawai()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'pegawai/pegawai_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editPegawai($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Dava', 'pegawai/pegawai_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/getPegawai');
			}
	...
	public function detailPegawai($id)
	{
		...
		$this->template->load('template/template_Dava', 'pegawai/pegawai_form_detail', $data);
	}
	...
	public function getRegional()
	{
		...
		$this->template->load('template/template_Dava', 'regional/regional_data', $data);
	}
	...
	public function addRegional()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'regional/regional_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editRegional($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Dava', 'regional/regional_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/getRegional');
			}
	...
	public function getWitel()
	{
		...
		$this->template->load('template/template_Dava', 'witel/witel_data', $data);
	}
	...
	public function addWitel()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'witel/witel_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editWitel($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Dava', 'witel/witel_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/getWitel');
			}
	...
	public function getDatel()
	{
		...
		$this->template->load('template/template_Dava', 'datel/datel_data', $data);
	}
	...
	public function addDatel()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'datel/datel_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editDatel($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Dava', 'datel/datel_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/getDatel');
			}
	...
	public function getSTO()
	{
		...
		$this->template->load('template/template_Dava', 'sto/sto_data', $data);
	}
	...
	public function addSTO()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'sto/sto_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editSTO($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Dava', 'sto/sto_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/getSTO');
			}
	...
	public function getSpecOLT()
	{
		...
		$this->template->load('template/template_Dava', 'specolt/specolt_data', $data);
	}
	...
	public function addSpecOLT()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'specolt/specolt_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editSpecOLT($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Dava', 'specolt/specolt_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/getSpecOLT');
			}
	...
	public function getODP()
	{
		...
		$this->template->load('template/template_Dava', 'odp/odp_data', $data);
	}

	public function viewListODP()
	{
		$this->template->load('template/template_Dava', 'odp/odp_data');
	}
	...
	{
		$this->template->load('template/template_Dava', 'odp/odp_form_import');
	}
	...
	public function addODP()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'odp/odp_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editODP($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Dava', 'odp/odp_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/viewListODP');
			}
	...
	public function getOLT()
	{
		...
		$this->template->load('template/template_Dava', 'olt/olt_data', $data);
	}

	public function uploadOLT()
	{
		$this->template->load('template/template_Dava', 'olt/olt_form_import');
	}
	...
	public function addOLT()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'olt/olt_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editOLT($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Dava', 'olt/olt_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Dava/getOLT');
			}
	...
	public function getValidasi()
	{
		...
		$this->template->load('template/template_Dava', 'validasi/validasi_data');
	}

	public function uploadValidasi()
	{
		$this->template->load('template/template_Dava', 'validasi/validasi_form_import');
	}
	...
	public function addValidasi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Dava', 'validasi/Validasi_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
...
/* End of file Dava.php */
/* Location: ./application/controllers/Dava.php */
