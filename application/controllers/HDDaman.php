...
class HDDaman extends CI_Controller
{
	...
	// Halaman Awal HDDaman
	public function index()
	{
		check_not_login();
		$this->template->load('template/template_HDDaman', 'dashboard_home');
	}
	...
	{	
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_HDDaman', 'template/edit_profile', $data);
			} else {
	...
	{
		$this->template->load('template/template_HDDaman', 'dashboard/filtering');
	}
	...
	public function getODP()
	{
		...
		$this->template->load('template/template_HDDaman', 'odp/odp_data', $data);
	}
	
	public function viewListODP()
	{
		$this->template->load('template/template_HDDaman', 'odp/odp_data');
	}
	...
	public function getValidasi()
	{
		...
		$this->template->load('template/template_HDDaman', 'validasi/validasi_data');
	}

	public function uploadValidasi()
	{
		$this->template->load('template/template_HDDaman', 'validasi/validasi_form_import');
	}
	...
	public function addValidasi()
	{
		...
		$this->form_validation->set_rules('idHDDaman1', 'ONSITE 1', 'required|max_length[20]|trim');
		$this->form_validation->set_rules('idHDDaman2', 'ONSITE 2', 'required|max_length[20]|trim');
...
/* End of file HDDaman.php */
/* Location: ./application/controllers/HDDaman.php */
