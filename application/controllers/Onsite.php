...
class Onsite extends CI_Controller
{
	...
	public function addPegawai()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Onsite', 'pegawai/pegawai_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editPegawai($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Onsite', 'pegawai/pegawai_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Onsite/getPegawai');
			}
	...
	public function detailPegawai($id)
	{
		...
		$this->template->load('template/template_Onsite', 'pegawai/pegawai_form_detail', $data);
	}
	...
	public function addRegional()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Onsite', 'regional/regional_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editRegional($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Onsite', 'regional/regional_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Onsite/getRegional');
			}
	...
	public function addWitel()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Onsite', 'witel/witel_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editWitel($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Onsite', 'witel/witel_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Onsite/getWitel');
			}
	...
	public function addDatel()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Onsite', 'datel/datel_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editDatel($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Onsite', 'datel/datel_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Onsite/getDatel');
			}
	...
	public function addSTO()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Onsite', 'sto/sto_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editSTO($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Onsite', 'sto/sto_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Onsite/getSTO');
			}
	...
	public function addSpecOLT()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Onsite', 'specolt/specolt_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editSpecOLT($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_Onsite', 'specolt/specolt_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Onsite/getSpecOLT');
			}
	...
	public function addODP()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Onsite', 'odp/odp_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editODP($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Onsite', 'odp/odp_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Onsite/viewListODP');
			}
	...
	{
		$this->template->load('template/template_Onsite', 'olt/olt_form_import');
	}
	...
	public function addOLT()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_Onsite', 'olt/olt_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editOLT($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_Onsite', 'olt/olt_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('Onsite/getOLT');
			}
	...
	{
		$this->template->load('template/template_Onsite', 'validasi/validasi_form_import');
	}
