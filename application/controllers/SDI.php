...
class SDI extends CI_Controller
{
	...
	public function addPegawai()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'pegawai/pegawai_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editPegawai($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_SDI', 'pegawai/pegawai_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('SDI/getPegawai');
			}
	...
	public function detailPegawai($id)
	{
		...
		$this->template->load('template/template_SDI', 'pegawai/pegawai_form_detail', $data);
	}
	...
	public function addRegional()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'regional/regional_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editRegional($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_SDI', 'regional/regional_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('SDI/getRegional');
			}
	...
	public function addWitel()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'witel/witel_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editWitel($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_SDI', 'witel/witel_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('SDI/getWitel');
			}
	...
	public function addDatel()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'datel/datel_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editDatel($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_SDI', 'datel/datel_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('SDI/getDatel');
			}
	...
	public function getSTO()
	{
		...
		$this->template->load('template/template_SDI', 'sto/sto_data', $data);
	}
	...
	public function addSTO()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'sto/sto_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editSTO($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_SDI', 'sto/sto_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('SDI/getSTO');
			}
	...
	public function addSpecOLT()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'specolt/specolt_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editSpecOLT($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				$data['row'] = $query->row();
				$this->template->load('template/template_SDI', 'specolt/specolt_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('SDI/getSpecOLT');
			}
	...
	{
		$this->template->load('template/template_SDI', 'odp/odp_form_import');
	}
	...
	public function addODP()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'odp/odp_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editODP($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_SDI', 'odp/odp_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('SDI/viewListODP');
			}
	...
	{
		$this->template->load('template/template_SDI', 'olt/olt_form_import');
	}
	...
	public function addOLT()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'olt/olt_form_add', $data);
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function editOLT($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($query->num_rows() > 0) {
				...
				$this->template->load('template/template_SDI', 'olt/olt_form_edit', $data);
			} else {
				$this->session->set_flashdata('danger', 'Data tidak ditemukan');
				redirect('SDI/getOLT');
			}
	...
	public function addValidasi()
	{
		...
		$this->form_validation->set_rules('noteSDI', 'NOTE', 'required|max_length[20]|trim');
		...
		if ($this->form_validation->run() == FALSE) {
			$this->template->load('template/template_SDI', 'validasi/Validasi_form_add');
		} else {
			$post = $this->input->post(null, TRUE);
	...
	public function exportValidasi()
	{
		...
		foreach ($query as $row) {
			...
			$activeSheet->setCellValue('Y' . $i, $row->noteSDI);
