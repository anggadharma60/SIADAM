 ...
 function load() {
    ...
    $("#btnNoOfRecEdit").click(function () {
        $("#AddControllEdit").empty();
...
function createControllEdit(NoOfRec) {
    var tbl = "";
    if(NoOfRec!=0){
        tbl = 
            "<table class='table table-responsive table-bordered table-hover' >"+
    ...
    if(!isNaN(NoOfRec)){
        for (i = 1; i <= NoOfRec; i++) {
            ...
            "<tr>" +    
                "<td>"+
                    "<input type='text' class='form-control' id='portOutSplitter' name='portOutSplitter[]' style='text-align:center;'/>"+
                "</td>"+
                "<td>"+
                    "<input type='text' class='form-control' id='QROutSplitter' name='QROutSplitter[]' value='' style='width:225px' maxlength=16/>"+
                "</td>"+
                "<td>"+
                    "<input type='text' class='form-control' id='port' name='port[]'  style='width:50px;text-align:center;'  />"+
                "</td>"+
                "<td>"+
                    "<input type='text' class='form-control' id='status' name='status[]' value='' style='width:225px' /maxlength=35>"+
                "</td>"+
